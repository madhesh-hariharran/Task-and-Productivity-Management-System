...
function TaskCard({ task, onEdit, onDelete, onQuickStatusChange }: TaskCardProps) {
    return (
        <div
            className="
            rounded-2xl
        ...
        >
            ...
            <div className="flex flex-wrap gap-2">
                {task.status !== "todo" && (
                    <button
                        onClick={() => onQuickStatusChange(task, "todo")}
                        className="
                        rounded-xl
                ...
                {task.status !== "in_progress" && (
                    <button
                        onClick={() => onQuickStatusChange(task, "in_progress")}
                        className="
                        rounded-xl
